...
public class JointManager : MonoBehaviour
{
    ...
    public Appendage leftFoot, rightFoot;
    ...
    Joint10, Joint11, Joint12, Joint13, Joint14, Joint15, Joint16, Joint17, Joint18;
    ...
    void Update()
    {
        //try to put some interpolation stuff here
    ...
    public void AlignData()
    {
        ...
        Vector3[] tempDepthPoints = new Vector3[30];
        tempDepthPoints = VidPan.AlignTextures(origins, inputPoints[1].x, inputPoints[1].y);//enable for 3d depth camera scan
        ...
        for (int i = 0; i < inputPoints.Length; i++)
        {
            if (i != 1)
            {
                ...
                //inputPoints[i].z = origins[i].z - offsetx.z;//enable for non depth camera 2d 
                inputPoints[i].z = tempDepthPoints[i].z;//enable for depth camera 3d
                //inputPoints[i].z = 10;
            }
        }
    ...
    public void SetBodyFromPoints()
    {
        ...
        rightFoot.SetPosition(inputPoints[19], inputPoints[21]);
        leftFoot.SetPosition(inputPoints[22], inputPoints[24]);
    }
    ...
    public void SetJoints()
    {
        ...
        Joint15.SetPointer(inputPoints[19]);
        Joint16.SetPointer(inputPoints[21]);
        Joint17.SetPointer(inputPoints[22]);
        Joint18.SetPointer(inputPoints[24]);
    }
