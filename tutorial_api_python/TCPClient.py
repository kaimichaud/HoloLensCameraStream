...
class TCPClient:
    ...
    async def tcp_echo_client(data, loop):              #This should be the ip4 address of the usb connection to the hololens --------------
        reader, writer = await asyncio.open_connection('169.254.81.229', 8080, loop=loop)
